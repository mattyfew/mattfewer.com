...
export default function CommandBar(props) {
  ...
  const actions = [
    ...
    },
    {
      ...
      keywords: 'send-email',
      section: 'General',
      perform: () => window.open('mailto:mattfewer@hotmail.com', '_blank'),
    ...
    },
    {
      ...
      icon: <i className='ri-music-2-line' style={iconStyle} />,
    },
    {
      id: 'github',
      name: 'Github',
      ...
      keywords: 'go-github',
      section: 'Follow',
      perform: () => (window.open('https://github.com/mattfewer', '_blank')),
    ...
    },
    {
      ...
      section: 'Follow',
      perform: () => (window.open('https://linkedin.com/in/mattfewer', '_blank')),
    ...
    },
    {
      ...
      section: 'Follow',
      perform: () => (window.open('https://instagram.com/mattyfew', '_blank')),
