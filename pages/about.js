...
export async function getStaticProps() {
  const meta = {
    ...
    description:
      "<p><strong>Hey, I'm Matt Fewer.</strong> I’m a software engineer and musician currently based in Berlin.</p><p>I'm currently a <strong>Senior Software Developer</strong> at Just Eat Takeaway.com. Before that, I was a programming teacher at SPICED Academy.</p><p>As a musician, performer, and music producer. I’ve worked with many original and cover acts throughout the New York, where I grew up.</p><p>When I’m not working, I enjoy snowboarding, reading, exercising, and lazing around with my wife and 2 cats.</p>",
...
function About(props) {
    ...
    return (
      <div className="about">
        <div className="about-section">
          <Image
            alt="Matt"
            src="/static/images/matt-fewer.jpg"
            width="336"
            height="336"
            placeholder="blur"
  ...
  return (
    <div className="single">
      ...
      <h2 style={{ marginBottom: 40 }}>Want to get in touch?</h2>
      <div>
        Send me an email at{" "}
        <a href="mailto:mattfewer@hotmail.com">mattfewer@hotmail.com</a>.
      </div>
